function getBathValue() {
  ...
  function onClickedEstimatePrice() {
    ...
    let url = "https://banglore-house-price-prediction-kn7w.onrender.com/predict_home_price"; //Use this if you are NOT using nginx which is first 7 tutorials
  ...
  function onPageLoad() {
    ...
    let url = "https://banglore-house-price-prediction-kn7w.onrender.com/get_location_names"; // Use this if you are NOT using nginx which is first 7 tutorials
